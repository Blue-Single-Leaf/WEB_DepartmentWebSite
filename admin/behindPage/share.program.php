...
$showpage = 5;
//获取数据总行数
$sql = "select id from program where self = 0";
$type="program";
...
$sql = "SELECT * FROM program where self = 0 LIMIT ".($page-1)*$pagesize .",$pagesize";
	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="share.program.php" class="active"><span>程序</span></a></li>
...
$page_banner.="<form action = 'share.program.php' method='get'>";
