...
$sql = "SELECT * FROM appfile LIMIT ".($page-1)*$pagesize .",$pagesize";
	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="super_app.php" class="active"><span>软件管理</span></a></li>
...
<!-- End Header -->
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left" id="ob_type">软件列表</h2>
					</div>
					<!-- End Box Head -->	
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
    					...
    					<form name="form1" id="form1" method="post" action="app.del.handle.php?check=more">
							<tr>
...
?>
                            ...
                            <tr>
                                ...
                                <td><a href="app.del.handle.php?id=<?php echo $result['id'];?>" onclick="javascript:return confir()">删除软件</a></td>
                            </tr>
<?php $i++;
	} 
	}
...
?>
                        ...
                        <br/><br/>
<div id="sub"> 
            <input type="submit" name="submit1" id="submit1" value="删除选中" onclick="javascript:return submit_confirm()"/>
</div></form>
<div id="page">
